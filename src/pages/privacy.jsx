...
const PrivacyPolicy = () => (
  <div>
    ...
    <p>
      By accessing the website at&nbsp;<a href="https://mattsommer.io">https://mattsommer.io</a>,
    ...
    <ol type="a">
      <li>
        ...
        (information or software) on Matt Sommer's website for personal,
      ...
      <li>This license shall automatically terminate if you violate any of these restrictions
        and may be terminated by Matt Sommer at any time. Upon terminating your viewing of
    ...
    <ol type="a">
      <li>The materials on Matt Sommer's website are provided on an 'as is' basis. Matt Sommer
      ...
      <li>Further, Matt Sommer does not warrant or make any representations concerning
    ...
    <p>In no event shall Matt Sommer or its suppliers be liable for any damages (including,
      without limitation, damages for loss of data or profit, or due to business interruption)
      arising out of the use or inability to use the materials on Matt Sommer's website, even
      if Matt Sommer or a Matt Sommer authorized representative has been notified orally or
    ...
    <p>The materials appearing on Matt Sommer's website could include technical, typographical,
      or photographic errors. Matt Sommer does not warrant that any of the materials on its
      website are accurate, complete or current. Matt Sommer may make changes to the materials
      contained on its website at any time without notice. However Matt Sommer does not make
      any commitment to update the materials.</p>

    <h3>6. Links</h3>

    <p>Matt Sommer has not reviewed all of the sites linked to its website and is not
      responsible for the contents of any such linked site. The inclusion of any link does
      not imply endorsement by Matt Sommer of the site. Use of any such linked website is at
      the user's own risk.</p>

    <h3>7. Modifications</h3>

    <p>Matt Sommer may revise these terms of service for its website at any time without
    ...
    <p>These terms and conditions are governed by and construed in accordance with the
      laws of California and you irrevocably submit to the exclusive jurisdiction of
    ...
    <p>It is Matt Sommer's policy to respect your privacy regarding any information we
      ...
      disclose and otherwise make use of personal information. We have outlined
    ...
    <ul>
      ...
      <li>We will collect and use personal information solely for fulfilling those
      ...
      <li>We will make readily available to customers information about our
        policies and practices relating to the management of personal information.</li>
      <li>We will only retain personal information for as long as necessary
        for the fulfilment of those purposes.</li>
    </ul>
    ...
    <p>We are committed to conducting our business in accordance with these
      ...
      information is protected and maintained. Matt Sommer may change this privacy policy from time to time at Matt Sommer's sole discretion.</p>
  </div>
)

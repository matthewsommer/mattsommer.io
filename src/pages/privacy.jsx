...
export default function PrivacyPolicy() {
  return (
    ...
    <div>
      ...
      <a href="https://mattsommer.io">https://mattsommer.io</a>
        ...
        <ol type="i">
            ...
            <li>
              attempt to decompile or reverse engineer
               any software contained on Matt Sommer’s website;
            </li>
            <li>
      ...
      <ol type="a">
        <li>
          The materials on Matt Sommer’s website are provided on an ’as is’ basis. Matt Sommer
        ...
        <li>
          Further, Matt Sommer does not warrant or make any representations concerning
      ...
      <p>
        In no event shall Matt Sommer or its suppliers be liable for any damages (including,
      ...
      <p>
        The materials appearing on Matt Sommer’s website could include technical, typographical,
      ...
      <p>
        Matt Sommer has not reviewed all of the sites linked to its website and is not
      ...
      <p>
        Matt Sommer may revise these terms of service for its website at any time without
      ...
      <p>
        It is Matt Sommer’s policy to respect your privacy regarding any information we
      ...
      <p>
        ...
        information is protected and maintained. Matt Sommer may
        change this privacy policy from time to time at Matt Sommer’s sole discretion.
    </p>
    </div>
    /* eslint-enable */
  );
